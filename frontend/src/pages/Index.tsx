        ...
        >
            ...
            >
                ...
                <p className="hero-subtitle mx-auto max-w-3xl text-balance text-white/70">
                    Protect your transactions with permanent threats
        ...
        >
            <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="features-subtitle mt-6 text-white/70">
                    Our AI security bot combines fraud detection, threat
                    intelligence, and permanent storage to keep you safe across
                    the blockchain.
                </p>
            </div>
                    ...
                    <div className="absolute inset-0">
                        ...
                        <div className="protection-feature-box softness-maximum feature-box-top-left">
                            ...
                            <p className="protection-feature-description">
                                The AI Security Bot reviews every wallet
                                address, and transaction the moment you interact
                                with it, catching the threats before they reach
                                the blockchain.
                            </p>
                        </div>
                        ...
                        <div className="protection-feature-box softness-maximum feature-box-top-right">
                            ...
                            <p className="protection-feature-description">
                                It cross-references against a permanent fraud
                                archive on Arweave.
                            </p>
                        </div>
                        ...
                        <div className="protection-feature-box softness-maximum feature-box-bottom-left">
                            ...
                            <p className="protection-feature-description">
                                You confirm or reject, risky actions are
                                auto-blocked if ignored.
                            </p>
                        </div>
                        ...
                        <div className="protection-feature-box feature-box-bottom-right softness-maximum">
                            ...
                            <p className="protection-feature-description">
                                Instead of confusing alerts, the bot gives you
                                clear explanations you can trust: "This
                                transaction looks routine and safe"
                            </p>
                        </div>
                    </div>
                </div>
        ...
        >
            <div className="intro-product-container">
                <div className="intro-product-content">
                    <h2 className="intro-product-title">
                        Introducing AO Shield
                    </h2>
                    <p className="intro-product-description">
                        AO Shield is an AI-powered fraud detection and
                        protection system built on AO, Arweave's scalable
                        compute layer. It identifies scams, flags malicious
                        actors, and secures transactions in real time — with a
                        permanent memory of threats stored on the permaweb.
                    </p>
                    <p className="intro-product-description">
                        By combining adaptive AI defense with AO's decentralized
                        architecture, AO Shield delivers trustless, transparent
                        protection that can't be erased or manipulated —
                        starting with Nigeria-first use cases and built to scale
                        globally.
                    </p>
                </div>
                <img
            ...
            <div className="bottom-cta-content">
                <div className="bottom-cta-text">
                    <h2 className="bottom-cta-title">
                        Experience AO Shield Today
                    </h2>
                    <p className="bottom-cta-description">
                        Tap into AI intelligence and decentralized protection.
                        With AO Shield, your defense against scams is always on,
                        transparent, and impossible to erase.
                    </p>
                </div>
...
const Footer: React.FC = () => {
    const social = [
        ...
        },
        {
            ...
            label: 'GitHub',
            icon: (
                <img src="/GithubLogo.svg" alt="GitHub" className="h-9 w-9" />
            ),
            href: '#',
        },
        {
            ...
            label: 'Discord',
            icon: (
                <img src="/DiscordLogo.svg" alt="Discord" className="h-9 w-9" />
            ),
            href: '#',
        },
    ];
    return (
        <footer className="bg-black/60 text-white">
            ...
            <div className="footer-copyright-text">
                © 2025 AO Shield. All rights reserved. | Privacy Policy | Terms
                of Use
            </div>
        </footer>
    );
